...
<head>
    ...
    <title>Painel Interativo para Responsável Técnico de Laboratório</title>
    ...
    <!-- Application Structure Plan: A thematic dashboard SPA with six main modules: 'Painel de Bordo' (overview), 'Guia Regulatório' (interactive RDC comparison), 'Módulo de Qualidade' (interactive tools), 'Liderança & Desenvolvimento' (team management strategies), 'Módulos de Estudo' (a hub linking to dedicated pages), and 'Documentos e Normas' (a resource hub for official PDFs). This structure provides a clear, multi-level navigation, allowing users to easily access high-level summaries, detailed content, and primary source documents without cluttering a single view. -->
    <!-- Visualization & Content Choices: 1. RDC Comparison -> Goal: Compare regulations -> Viz: Interactive accordion. 2. Westgard Rules -> Goal: Teach error patterns -> Viz: Levey-Jennings Chart. 3. Study Modules -> Goal: Present curriculum -> Viz: Hub page with cards linking to detail pages. 4. Document Hub -> Goal: Provide direct access to regulations -> Viz: Grid of cards with external links -> Interaction: Click to open PDF in new tab. Justification: This dedicated resource hub is a user-friendly way to provide direct access to essential, non-summarized regulatory documents. -->
...
<body class="antialiased">
    ...
    <main class="container mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <section id="study" class="page-content hidden">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                ...
                <div class="card p-6 text-center cursor-pointer" onclick="showStudyModule(3)">
                    ...
                    <p class="text-gray-600">Aplique ferramentas de controle interno e externo para assegurar resultados confiáveis.</p>
                </div>
                ...
                <div class="card p-6 mb-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <p class="mt-2"><strong>Principais tópicos:</strong> Comunicação Eficiente, Divisão de Tarefas, Gestão de Conflitos, Treinamento Contínuo.</p>
        ...
        <!-- Study Module 4 Detail Page (Placeholder) -->
    ...
    <script>
        ...
        const actionPlanData = [
            ...
            {
                step: "Passo 4: Desenvolvimento da Liderança e da Equipe",
        ...
        function renderWestgardChart(dataSetKey = 'normal') {
        ...
        function openRiskModal(riskStep) {
